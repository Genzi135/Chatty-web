...
const icons = {
    ...
    leaveGroup: <BsBoxArrowRight size={20} />,
    changeLeader: <BsPersonCheck size={20} />,
    leaderStar: <BsStars size={20} />,
}
